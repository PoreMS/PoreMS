...
Create a pore with a diameter of 5 nm, a length of 10 nm, and a reservoir length of 5 nm. The silanol on the inner surface is 6.06 $\mathrm{\mu mol\ m^{-2}}$. The outer surface is completely occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$.
...
# Drill a cylinder in the SiO2 block with a diameter of 5 nm and inner silanol concentration of 6.06 mumol/m2
...
Create 2 parallel pores with a diameter of 5 nm, a length of 10 nm and a reservoir length of 5 nm. The silanol on the inner surface is 6.06 $\mathrm{\mu mol\ m^{-2}}$. The outer surface is completely occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$.
...
# Drill two cylinders in the SiO2 block with a diameter of 5 nm and inner silanol concentration of 6.06 mumol/m2
...
Generate 2 parallel pores with a diameter of 5 nm, a length of 10 nm connected with a 2.5 nm pore and a reservoir length of 5 nm. The silanol on the inner surface is 6.06 $\mathrm{\mu mol\ m^{-2}}$. The outer surface is completely occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$.
...
Generate 3 pores with a diameter of 5 nm directly adjacent to each other in z-direction. The silanol on the inner surface is 6.06 $\mathrm{\mu mol\ m^{-2}}$ in the second pore (shape_01). Shape_00 and shape_02 are occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$. The outer surface is completely occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$.
...
# Drill three cylinders with the same central in x,y direction
...
## Shape 5 (Cone-connected pores)

Generate 3 pores with a diameter of 5, 2.5 and 5 nm directly adjacent to each other in z-direction connected with a cone shape. The outer surface is completely occupied by TMS molecules with 6.06 $\mathrm{\mu mol\ m^{-2}}$.
...
# Build cone-connected multi-pore system
