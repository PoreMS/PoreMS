...
Since the catalyst molecules are placed far enough apart so they do not interact or influence each other, a point symmetrical placement is chosen, for which a special attachment function is used.
